# RFC-0170 — Semantic Agent Reasoning Evaluation Engine Specification
...
Esta RFC formaliza **Reasoning Evaluation Engine** como um artefato semântico de primeira classe do AllasCode. Seu objetivo é retirar significado de implementações implícitas e convertê-lo em contrato versionável, componível, verificável e auditável.

> **Semântica antes do mecanismo. A implementação pode mudar; o contrato semântico deve permanecer verificável.**

## Motivação

Sistemas agentivos não devem depender de significado escondido em código, prompts, infraestrutura ou convenções locais. Esta RFC delimita a responsabilidade de **Reasoning Evaluation Engine**, suas relações com os demais componentes e as propriedades que uma implementação precisa demonstrar.

## Escopo semântico

Avalia e compõe resultados do raciocínio, distinta do engine de raciocínio de RFC-0148.
...
artifact:
  id: "rfc-0170"
  canonical_label: "reasoning.evaluation.engine"
  version: "1.0.0"
