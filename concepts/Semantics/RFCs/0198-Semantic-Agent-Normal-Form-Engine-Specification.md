# RFC-0198 — Semantic Agent Normal Form Engine Specification
...
Esta RFC formaliza **Normal Form Engine** como um artefato semântico de primeira classe do AllasCode. Seu objetivo é retirar significado de implementações implícitas e convertê-lo em contrato versionável, componível, verificável e auditável.

> **Semântica antes do mecanismo. A implementação pode mudar; o contrato semântico deve permanecer verificável.**

## Motivação

Sistemas agentivos não devem depender de significado escondido em código, prompts, infraestrutura ou convenções locais. Esta RFC delimita a responsabilidade de **Normal Form Engine**, suas relações com os demais componentes e as propriedades que uma implementação precisa demonstrar.

## Escopo semântico

Define o escopo semântico específico de Normal Form Engine.
...
artifact:
  id: "rfc-0198"
  canonical_label: "normal.form.engine"
  version: "1.0.0"
...
**RFC-0199 — Semantic Agent Formal Proof Engine Specification**
