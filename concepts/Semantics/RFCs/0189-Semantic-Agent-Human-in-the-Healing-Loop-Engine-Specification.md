...
Esta RFC formaliza **Human-in-the-Healing-Loop Engine** como um artefato semântico de primeira classe do AllasCode. Seu objetivo é retirar significado de implementações implícitas e convertê-lo em contrato versionável, componível, verificável e auditável.
...
Identity + Trust + Governance
  ↓
Human-in-the-Healing-Loop Engine
  ↓
Typed Result
  ↓
Evidence
...
artifact:
  id: "rfc-0189"
  canonical_label: "human.in.the.healing.loop.engine"
  version: "1.0.0"
