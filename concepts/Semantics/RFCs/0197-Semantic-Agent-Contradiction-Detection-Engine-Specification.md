...
Esta RFC formaliza **Contradiction Detection Engine** como um artefato semântico de primeira classe do AllasCode. Seu objetivo é retirar significado de implementações implícitas e convertê-lo em contrato versionável, componível, verificável e auditável.
...
artifact:
  id: "rfc-0197"
  canonical_label: "contradiction.detection.engine"
  version: "1.0.0"
