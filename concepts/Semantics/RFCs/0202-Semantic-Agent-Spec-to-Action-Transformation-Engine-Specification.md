# RFC-0202 — Semantic Agent Spec-to-Action Transformation Engine Specification
...
Esta RFC formaliza **Spec-to-Action Transformation Engine** como um artefato semântico de primeira classe do AllasCode. Seu objetivo é retirar significado de implementações implícitas e convertê-lo em contrato versionável, componível, verificável e auditável.

> **Semântica antes do mecanismo. A implementação pode mudar; o contrato semântico deve permanecer verificável.**

## Motivação

Sistemas agentivos não devem depender de significado escondido em código, prompts, infraestrutura ou convenções locais. Esta RFC delimita a responsabilidade de **Spec-to-Action Transformation Engine**, suas relações com os demais componentes e as propriedades que uma implementação precisa demonstrar.

## Escopo semântico

Define o escopo semântico específico de Spec-to-Action Transformation Engine.
...
Identity + Trust + Governance
  ↓
Spec-to-Action Transformation Engine
  ↓
Typed Result
  ↓
Evidence
...
artifact:
  id: "rfc-0202"
  canonical_label: "spec.to.action.transformation.engine"
  version: "1.0.0"
...
**RFC-0203 — Semantic Agent Micro-Skill Generation Engine Specification**
