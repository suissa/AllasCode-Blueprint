# RFC-0191 — Semantic Agent Actor Runtime Engine Specification
...
Esta RFC formaliza **Actor Runtime Engine** como um artefato semântico de primeira classe do AllasCode. Seu objetivo é retirar significado de implementações implícitas e convertê-lo em contrato versionável, componível, verificável e auditável.

> **Semântica antes do mecanismo. A implementação pode mudar; o contrato semântico deve permanecer verificável.**

## Motivação

Sistemas agentivos não devem depender de significado escondido em código, prompts, infraestrutura ou convenções locais. Esta RFC delimita a responsabilidade de **Actor Runtime Engine**, suas relações com os demais componentes e as propriedades que uma implementação precisa demonstrar.

## Escopo semântico

Define o escopo semântico específico de Actor Runtime Engine.
...
artifact:
  id: "rfc-0191"
  canonical_label: "actor.runtime.engine"
  version: "1.0.0"
...
**RFC-0192 — Semantic Agent Atomic Action Engine Specification**
