# RFC-0113 — Semantic Agent Interaction Protocol Specification
...
Esta RFC formaliza **Interaction Protocol** como um artefato semântico de primeira classe do AllasCode. Seu objetivo é retirar significado de implementações implícitas e convertê-lo em contrato versionável, componível, verificável e auditável.

> **Semântica antes do mecanismo. A implementação pode mudar; o contrato semântico deve permanecer verificável.**

## Motivação

Sistemas agentivos não devem depender de significado escondido em código, prompts, infraestrutura ou convenções locais. Esta RFC delimita a responsabilidade de **Interaction Protocol**, suas relações com os demais componentes e as propriedades que uma implementação precisa demonstrar.

## Escopo semântico

Define o escopo semântico específico de Interaction Protocol.
...
artifact:
  id: "rfc-0113"
  canonical_label: "interaction.protocol"
  version: "1.0.0"
...
**RFC-0114 — Semantic Agent Coordination Specification**
