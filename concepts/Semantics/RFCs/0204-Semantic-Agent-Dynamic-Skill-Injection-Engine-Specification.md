...
Esta RFC formaliza **Dynamic Skill Injection Engine** como um artefato semântico de primeira classe do AllasCode. Seu objetivo é retirar significado de implementações implícitas e convertê-lo em contrato versionável, componível, verificável e auditável.
...
artifact:
  id: "rfc-0204"
  canonical_label: "dynamic.skill.injection.engine"
  version: "1.0.0"
