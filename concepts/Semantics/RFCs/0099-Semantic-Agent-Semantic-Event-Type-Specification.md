...
Esta RFC formaliza **Semantic Event Type** como um artefato semântico de primeira classe do AllasCode. Seu objetivo é retirar significado de implementações implícitas e convertê-lo em contrato versionável, componível, verificável e auditável.
...
artifact:
  id: "rfc-0099"
  canonical_label: "semantic.event.type"
  version: "1.0.0"
