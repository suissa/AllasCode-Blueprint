# RFC-0174 — Semantic Agent Constraint Engine Specification
...
Esta RFC formaliza **Constraint Engine** como um artefato semântico de primeira classe do AllasCode. Seu objetivo é retirar significado de implementações implícitas e convertê-lo em contrato versionável, componível, verificável e auditável.

> **Semântica antes do mecanismo. A implementação pode mudar; o contrato semântico deve permanecer verificável.**

## Motivação

Sistemas agentivos não devem depender de significado escondido em código, prompts, infraestrutura ou convenções locais. Esta RFC delimita a responsabilidade de **Constraint Engine**, suas relações com os demais componentes e as propriedades que uma implementação precisa demonstrar.

## Escopo semântico

Define o escopo semântico específico de Constraint Engine.
...
artifact:
  id: "rfc-0174"
  canonical_label: "constraint.engine"
  version: "1.0.0"
...
**RFC-0175 — Semantic Agent Policy Engine Specification**
