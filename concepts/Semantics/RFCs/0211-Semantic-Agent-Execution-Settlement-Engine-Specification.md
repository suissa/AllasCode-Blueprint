...
Esta RFC formaliza **Execution Settlement Engine** como um artefato semântico de primeira classe do AllasCode. Seu objetivo é retirar significado de implementações implícitas e convertê-lo em contrato versionável, componível, verificável e auditável.
...
artifact:
  id: "rfc-0211"
  canonical_label: "execution.settlement.engine"
  version: "1.0.0"
