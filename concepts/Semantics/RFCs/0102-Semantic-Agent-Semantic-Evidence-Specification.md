# RFC-0102 — Semantic Agent Semantic Evidence Specification
...
Esta RFC formaliza **Semantic Evidence** como um artefato semântico de primeira classe do AllasCode. Seu objetivo é retirar significado de implementações implícitas e convertê-lo em contrato versionável, componível, verificável e auditável.

> **Semântica antes do mecanismo. A implementação pode mudar; o contrato semântico deve permanecer verificável.**

## Motivação

Sistemas agentivos não devem depender de significado escondido em código, prompts, infraestrutura ou convenções locais. Esta RFC delimita a responsabilidade de **Semantic Evidence**, suas relações com os demais componentes e as propriedades que uma implementação precisa demonstrar.

## Escopo semântico

Define o escopo semântico específico de Semantic Evidence.
...
artifact:
  id: "rfc-0102"
  canonical_label: "semantic.evidence"
  version: "1.0.0"
...
**RFC-0103 — Semantic Agent Semantic Proof Specification**
