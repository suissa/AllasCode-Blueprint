...
Esta RFC formaliza **Semantic Behavior-Typed Algebra Engine** como um artefato semântico de primeira classe do AllasCode. Seu objetivo é retirar significado de implementações implícitas e convertê-lo em contrato versionável, componível, verificável e auditável.
...
Identity + Trust + Governance
  ↓
Semantic Behavior-Typed Algebra Engine
  ↓
Typed Result
  ↓
Evidence
...
artifact:
  id: "rfc-0194"
  canonical_label: "semantic.behavior.typed.algebra.engine"
  version: "1.0.0"
