...
Esta RFC formaliza **Coordination** como um artefato semântico de primeira classe do AllasCode. Seu objetivo é retirar significado de implementações implícitas e convertê-lo em contrato versionável, componível, verificável e auditável.
...
Define o escopo semântico específico de Coordination.
...
**RFC-0115 — Semantic Agent Workflow Specification**
