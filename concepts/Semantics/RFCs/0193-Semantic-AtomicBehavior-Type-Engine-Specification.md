# RFC-0193 — Semantic AtomicBehavior Type Engine Specification
...
Esta RFC formaliza **Semantic AtomicBehavior Type Engine** como um artefato semântico de primeira classe do AllasCode. Seu objetivo é retirar significado de implementações implícitas e convertê-lo em contrato versionável, componível, verificável e auditável.

> **Semântica antes do mecanismo. A implementação pode mudar; o contrato semântico deve permanecer verificável.**

## Motivação

Sistemas agentivos não devem depender de significado escondido em código, prompts, infraestrutura ou convenções locais. Esta RFC delimita a responsabilidade de **Semantic AtomicBehavior Type Engine**, suas relações com os demais componentes e as propriedades que uma implementação precisa demonstrar.

## Escopo semântico

Define o escopo semântico específico de Semantic AtomicBehavior Type Engine.
...
Identity + Trust + Governance
  ↓
Semantic AtomicBehavior Type Engine
  ↓
Typed Result
  ↓
Evidence
...
artifact:
  id: "rfc-0193"
  canonical_label: "semantic.atomicbehavior.type.engine"
  version: "1.0.0"
...
**RFC-0194 — Semantic Behavior-Typed Algebra Engine Specification**
