...
Esta RFC formaliza **Semantic Proof** como um artefato semântico de primeira classe do AllasCode. Seu objetivo é retirar significado de implementações implícitas e convertê-lo em contrato versionável, componível, verificável e auditável.
...
artifact:
  id: "rfc-0103"
  canonical_label: "semantic.proof"
  version: "1.0.0"
