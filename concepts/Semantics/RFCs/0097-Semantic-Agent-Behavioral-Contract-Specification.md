# RFC-0097 — Semantic Agent Behavioral Contract Specification
...
Esta RFC formaliza **Behavioral Contract** como um artefato semântico de primeira classe do AllasCode. Seu objetivo é retirar significado de implementações implícitas e convertê-lo em contrato versionável, componível, verificável e auditável.

> **Semântica antes do mecanismo. A implementação pode mudar; o contrato semântico deve permanecer verificável.**

## Motivação

Sistemas agentivos não devem depender de significado escondido em código, prompts, infraestrutura ou convenções locais. Esta RFC delimita a responsabilidade de **Behavioral Contract**, suas relações com os demais componentes e as propriedades que uma implementação precisa demonstrar.

## Escopo semântico

Define o escopo semântico específico de Behavioral Contract.
...
artifact:
  id: "rfc-0097"
  canonical_label: "behavioral.contract"
  version: "1.0.0"
...
**RFC-0098 — Semantic Agent Semantic Type Specification**
