# RFC-0132 — Semantic Agent Evaluation Criteria Specification
...
Esta RFC formaliza **Evaluation Criteria** como um artefato semântico de primeira classe do AllasCode. Seu objetivo é retirar significado de implementações implícitas e convertê-lo em contrato versionável, componível, verificável e auditável.

> **Semântica antes do mecanismo. A implementação pode mudar; o contrato semântico deve permanecer verificável.**

## Motivação

Sistemas agentivos não devem depender de significado escondido em código, prompts, infraestrutura ou convenções locais. Esta RFC delimita a responsabilidade de **Evaluation Criteria**, suas relações com os demais componentes e as propriedades que uma implementação precisa demonstrar.

## Escopo semântico

Define critérios e métodos de avaliação, distinta da avaliação como conceito geral de RFC-0118.
...
artifact:
  id: "rfc-0132"
  canonical_label: "evaluation.criteria"
  version: "1.0.0"
...
**RFC-0133 — Semantic Agent Learning Adaptation Specification**
